...
class QnA extends React.Component<any, any> {
  ...
  public changeQuestion = (question: any, index: number) => {
    this.setState({
      questions: this.state.questions.map((currentQuestion: any, currentIndex: number) => currentIndex === index ? question : currentQuestion),
    });
  }
  ...
  private handleLanguage = (e: any) => {
    ...
    axios({
      ...
      method: 'post',
      headers: {
        'Ocp-Admin-Subscription-Key': subscriptionKey,
    ...
    return (
      <div>
        ...
        <div className="qna-container">
          <QuestionsList 
            questions = {questions}
            changeQuestion = {(question: any, index: number) => this.changeQuestion(question, index)}
          />
          <Answer 
            answer = {answer}
          ...
          <div className="button-language">
            <button className="qna-container-button" value = 'fr' onClick = { this.handleLanguage } > French </button>
            <button className="qna-container-button" value = 'en' onClick = { this.handleLanguage } > English </button>
            <button className="qna-container-button" value = 'de' onClick = { this.handleLanguage } > Deutsh </button>
          </div>
        </div>
      </div>
    )
